...
> Note: For the time being, these are both seen as *integration tests* __and__ *binary targets* by the compiler. Basically meaning the server has to be running in parallel to launch these tests.
