...
pub struct MetricReply {
    ...
    #[prost(string, tag = "6")]
    pub used_memory: ::prost::alloc::string::String,
    #[prost(string, tag = "7")]
    pub percent_memory: ::prost::alloc::string::String,
    #[prost(string, tag = "8")]
...
pub mod health_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
        ...
        ) -> std::result::Result<tonic::Response<super::MetricReply>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let path = http::uri::PathAndQuery::from_static("/health.Health/Get");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("health.Health", "Get"));
        ...
        pub async fn watch(
            ...
            tonic::Response<tonic::codec::Streaming<super::MetricReply>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod health_server {
    ...
    pub trait Health: Send + Sync + 'static {
        async fn get(
            &self,
            request: tonic::Request<super::MetricRequest>,
        ) -> std::result::Result<tonic::Response<super::MetricReply>, tonic::Status>;
        /// Server streaming response type for the Watch method.
        type WatchStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::MetricReply, tonic::Status>,
            >
            + Send
            + 'static;
        async fn watch(
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/health.Health/Get" => {
                    ...
                    struct GetSvc<T: Health>(pub Arc<T>);
                    impl<T: Health> tonic::server::UnaryService<super::MetricRequest>
                    for GetSvc<T> {
                        type Response = super::MetricReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Health>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/health.Health/Watch" => {
                    ...
                    impl<
                        T: Health,
                    > tonic::server::ServerStreamingService<super::MetricRequest>
                    for WatchSvc<T> {
                        type Response = super::MetricReply;
